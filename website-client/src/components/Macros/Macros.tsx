        ...
        return <div>
            ...
            <div hidden={this.state.editMacro === ""}>
                <Typography component="p">
                    Write a macro below.
                    The latest supported commands can be found <Link target="_blank"
                                                                     href="https://github.com/juharris/switch-remoteplay/blob/master/server/README.md#api">here</Link>.
                </Typography>
                <Typography component="p">
                ...
                <pre
                    className={classes.macroCode}>{'["s l up", "wait 200", "a d", "wait 350", "a u", "wait 200", "s l center"]'}</pre>
                <div>
                    <TextField className={classes.macroName} label="Macro Name" name="macroName"
                               value={this.state.macroName} onChange={this.handleChange}/>
                </div>
                <div>
                    <TextareaAutosize className={classes.macroText} name="editMacro" value={this.state.editMacro}
                                      aria-label="Macro" onChange={this.handleChange}/>
                </div>
                <Grid container>
                    <Grid item>
